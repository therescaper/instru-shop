...
window.SHOP = {
  ...
  products: [
    ...
    { id: 'ench-unbreaking-3', name: 'Solidité 3 "Unbreaking 3"', category: 'Livre enchanté', shelf: 'Enchantements', image: 'enchanted_book', description: 'Livre enchanté prêt pour tes outils, armes ou armures.', unit: 'livre', prices: { fer: 48, or: 48, diamants: 8 } },
    { id: 'ench-quick-charge-3', name: 'Charge rapide 3 "Quick Charge 3"', category: 'Livre enchanté', shelf: 'Enchantements', image: 'enchanted_book', description: 'Livre enchanté pour arbalète.', unit: 'livre', prices: { fer: 20, or: 20, diamants: 2 } },
    { id: 'ench-silk-touch', name: 'Toucher de soie "Silk Touch"', category: 'Livre enchanté', shelf: 'Enchantements', image: 'enchanted_book', description: 'Livre enchanté pour récupérer les blocs fragiles.', unit: 'livre', prices: { fer: 32, or: 32, diamants: 6 } },
    { id: 'ench-punch-2', name: 'Frappe 2 "Punch 2"', category: 'Livre enchanté', shelf: 'Enchantements', image: 'enchanted_book', description: 'Livre enchanté pour arc.', unit: 'livre', prices: { fer: 20, or: 20, diamants: 2 } },
    { id: 'ench-knockback-2', name: 'Recul 2 "Knockback 2"', category: 'Livre enchanté', shelf: 'Enchantements', image: 'enchanted_book', description: 'Livre enchanté pour épée.', unit: 'livre', prices: { fer: 20, or: 20, diamants: 2 } },
    { id: 'ench-fortune-3', name: 'Fortune 3 "Fortune 3"', category: 'Livre enchanté', shelf: 'Enchantements', image: 'enchanted_book', description: 'Livre enchanté pour augmenter tes drops.', unit: 'livre', prices: { fer: 48, or: 48, diamants: 8 } },
    { id: 'ench-flame', name: 'Flamme "Flame"', category: 'Livre enchanté', shelf: 'Enchantements', image: 'enchanted_book', description: 'Livre enchanté pour arc.', unit: 'livre', prices: { fer: 32, or: 32, diamants: 6 } },
    { id: 'ench-infinity', name: 'Infinité "Infinity"', category: 'Livre enchanté', shelf: 'Enchantements', image: 'enchanted_book', description: 'Livre enchanté pour arc.', unit: 'livre', prices: { fer: 32, or: 32, diamants: 6 } },
    { id: 'ench-looting-3', name: 'Butin 3 "Looting 3"', category: 'Livre enchanté', shelf: 'Enchantements', image: 'enchanted_book', description: 'Livre enchanté pour augmenter tes drops de mobs.', unit: 'livre', prices: { fer: 48, or: 48, diamants: 8 } },
    { id: 'ench-protection-4', name: 'Protection 4 "Protection 4"', category: 'Livre enchanté', shelf: 'Enchantements', image: 'enchanted_book', description: 'Livre enchanté pour armure.', unit: 'livre', prices: { fer: 64, or: 64, diamants: 12 } },

...
window.SHOP = {
  ...
  products: [
    ...
    { id: 'ench-fortune-3', name: 'Fortune 3', category: 'Livre enchanté', shelf: 'Enchantements', image: 'enchanted_book', description: 'Livre enchanté pour augmenter tes drops.', unit: 'livre', prices: { fer: 48, or: 48, diamants: 8 } },
